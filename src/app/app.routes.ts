...
export const routes: Routes = [
  ...
  // ADMIN SHOWS (tider)
  {
    ...
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./pages/admin/admin-show-list/admin-show-list')
        .then(m => m.AdminShowList),
  },
  {
    path: 'admin/shows/create',
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./pages/admin/admin-show-create/admin-show-create')
        .then(m => m.AdminShowCreate),
  },
  {
    path: 'admin/shows/edit/:id',
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./pages/admin/admin-show-edit/admin-show-edit')
        .then(m => m.AdminShowEdit),
  },
